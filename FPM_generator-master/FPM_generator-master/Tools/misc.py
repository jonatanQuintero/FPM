...
def add_complex_colorwheel(fig, ax, loc=4, width=0.2, height=0.2, pad=0.05):
    ...
    axins = inset_axes(ax, width=width, height=height, loc=loc, borderpad=pad)
    """
...
def simulate_cmos_image(field, bit_depth=12, peak_photons=30000, quantum_efficiency=0.8,
                       quantum_well=40000, readout_noise=4, dc_level=100):
    """
