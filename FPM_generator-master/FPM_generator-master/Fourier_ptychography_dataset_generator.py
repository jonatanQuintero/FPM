...
z0 = 45e-2  # Aumentar la distancia entre LEDs y muestra
wavelength = 800e-9  # Aumentar la longitud de onda
...
print(f'Np: {Np}, Np_inner: {Np_inner}')
